...
# Detectar o diretório raiz do projeto (um nível acima de scripts/)
...
export VITE_API_URL=http://${HOST_IP}:3002/api
...
echo ""
echo -e "${BLUE}📝 URLs:${NC}"
echo -e "   Backend:  ${GREEN}http://${HOST_IP}:3002${NC} (ou http://localhost:3002)"
echo -e "   Frontend: ${GREEN}http://${HOST_IP}:5173${NC} (ou http://localhost:5173)"
echo -e "   API:      ${GREEN}http://${HOST_IP}:3002/api${NC}"
echo ""
